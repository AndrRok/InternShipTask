...
final class AlertVC: UIViewController {
    ...
    private let titleLabel   = MainLabel(textAlignment: .left, fontSize: 20, weight: .medium)
    private let messageLabel = MainLabel(textAlignment: .left, fontSize: 20, weight: .medium)
